    ...
    <>
      <div className="h-[55em] min-h-screen  w-full flex items-center flex-col justify-center bg-slate-900 text-white p-6">
        <div className='w-full md:w-3/6 h-5/6 flex justify-center flex-col'>
          <div className="text-4xl font-mono font-bold tracking-tight text-slate-200 sm:text-5xl" data-aos="fade-down" data-aos-duration="1750">Hi, I'm Owen Watt.</div>
          <div className='mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl'>Computer Science Student</div>
          <div className='text-md md:text-xl my-4 md:my-7 text-slate-300/90 font-sans w-5/6 md:w-[500px]'>
